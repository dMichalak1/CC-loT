...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "IntroductionToXamarinForms.Android.dll" comes first in this list. */
		"IntroductionToXamarinForms.Android.dll",
		"FormsViewGroup.dll",
		"IntroductionToXamarinForms.dll",
